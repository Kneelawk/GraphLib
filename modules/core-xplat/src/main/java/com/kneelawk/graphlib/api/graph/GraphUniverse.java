...
public interface GraphUniverse {
     ...
     */
    @NotNull GraphWorld getGraphWorld(@NotNull ServerLevel world);
     ...
     */
    @Nullable BlockNodeType getNodeType(@NotNull ResourceLocation typeId);
     ...
     */
    @Nullable NodeEntityType getNodeEntityType(@NotNull ResourceLocation typeId);
     ...
     */
    @Nullable LinkEntityType getLinkEntityType(@NotNull ResourceLocation typeId);
     ...
     */
    @Nullable GraphEntityType<?> getGraphEntityType(@NotNull ResourceLocation typeId);
    ...
    interface Builder {
         ...
         */
        @NotNull GraphUniverse build(@NotNull ResourceLocation universeId);
