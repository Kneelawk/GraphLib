...
public interface RegionBasedStorage<R> extends AutoCloseable {
    /**
     * Attachment key for the function to mark a chunk as dirty.
     */
    AttachmentKey<Runnable> MARK_DIRTY = AttachmentKey.ofStaticFieldName();

    /**
     * Attachment key for the section position a storage chunk is located in.
     */
    AttachmentKey<SectionPos> SECTION_POS = AttachmentKey.ofStaticFieldName();
