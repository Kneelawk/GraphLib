...
public interface BlockNodeRenderer<N extends ClientBlockNode> {
     ...
     */
    void render(@NotNull N node, @NotNull Node<ClientNodeKey, ClientBlockNodeHolder> holderNode,
     ...
     */
    @NotNull Vec3d getLineEndpoint(@NotNull N node, @NotNull Node<ClientNodeKey, ClientBlockNodeHolder> holderNode,
