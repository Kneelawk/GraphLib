...
public final class GraphLibClient {
    ...
    public static final Registry<BlockNodePacketDecoder> BLOCK_NODE_PACKET_DECODER =
        new SimpleRegistry<>(BLOCK_NODE_PACKET_DECODER_KEY, Lifecycle.experimental(), null);
    ...
    static void register() {
        Registry.register((Registry<Registry<?>>) Registry.REGISTRIES, BLOCK_NODE_PACKET_DECODER_ID,
            BLOCK_NODE_PACKET_DECODER);
        Registry.register((Registry<Registry<?>>) Registry.REGISTRIES, BLOCK_NODE_RENDERER_ID,
            BLOCK_NODE_RENDERER);
