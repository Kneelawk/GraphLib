...
public record BlockNodeRendererHolder<N extends ClientBlockNode>(@NotNull Class<N> nodeClass,
    ...
    public void render(@NotNull ClientBlockNode node, @NotNull Node<ClientNodeKey, ClientBlockNodeHolder> holderNode,
    ...
    public Vec3d getLineEndpoint(@NotNull ClientBlockNode node,
                                 @NotNull Node<ClientNodeKey, ClientBlockNodeHolder> holderNode,
